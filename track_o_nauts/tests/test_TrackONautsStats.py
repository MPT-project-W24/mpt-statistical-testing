...
class TestCorrelation(unittest.TestCase):
    ...
    def test_corr_rowi_vs_all_row_of_0(self):
        ...
        assert compPOP.all is True, "There was a row of zeros that resulted in NaN correlation values"

    def test_corr_rowi_vs_all_work_across_df(self):
        corr1 = TrackONautsStats.corr_rowi_vs_all(df_exp1.iloc[1], df_exp2)
...
dummy_df1 = pd.DataFrame([[-1, 0, 1, 0, 0], [1, 0, -1, 0, 1], [0.5, 0.5, 0.5, 0, 7]],
                         columns=["A", "B", "C", "D", "E"])
